...
export function CorrelationCard() {
  ...
  if (isLoading) return <Card className="w-96"><CardContent className="pt-6">Loading...</CardContent></Card>;
  ...
  return (
    <Card className="w-96">
      <CardHeader>
        ...
        <CardDescription>
          Which tweet metrics impact virality the most?
        </CardDescription>
      </CardHeader>
          ...
          .map(([metric, value]) => (
            <div key={metric} className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg font-bold">{metricLabels[metric as keyof typeof metricLabels]}</span>
              </div>
